...
$data_total_penjual = mysqli_fetch_assoc($total_penjual);

$total_aktif = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM user WHERE role='penjual' AND status='aktif'");
$data_aktif = mysqli_fetch_assoc($total_aktif);

$total_nonaktif = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM user WHERE role='penjual' AND status='nonaktif'");
    ...
    <main class="main-content">
        ...
        <section class="topbar">
            <div>
                <h1>List Penjual</h1>
                <p>
                    Lihat data akun penjual yang terdaftar di CINTESA.
        ...
        <section class="stats-grid">
            <div class="stat-card">
                <h3>Total Penjual</h3>
                <p><?php echo $data_total_penjual['total']; ?></p>
            </div>
        ...
        <section class="section-card">
            ...
            <div class="section-header">
                <div>
                    ...
                    <p>Pantau akun penjual, status akun, dan informasi kontak yang terdaftar.</p>
                </div>
                        ...
                        <tr>
                            <td colspan="9" class="empty-cell">
                                <div class="empty-state">
                                    ...
                                    <h3>Belum ada data penjual</h3>
                                    <p>Data penjual yang terdaftar akan tampil di tabel ini.</p>
                                </div>
                            </td>
                        </tr>
