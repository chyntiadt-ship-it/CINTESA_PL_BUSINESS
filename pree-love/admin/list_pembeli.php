...
<nav class="top-navbar">
    ...
    <div class="nav-center">
        <form method="GET" action="list_pembeli.php" class="admin-search-form" id="searchForm">
            <input 
                type="text" 
                name="q"
                id="searchInput"
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="dropdown-menu show">
            ...
            <a href="list_pembeli.php" class="active">List Pembeli</a>
        </div>
...
<div class="admin-container">
    ...
    <div class="admin-header">
        <h1>List <span class="brand">Pembeli</span></h1>
        <p>Kelola dan lihat semua data akun pembeli</p>
    </div>
    ...
    <?php if ($keyword != ''): ?>
        <div class="search-result-info">
            ...
            <a href="list_pembeli.php">Reset</a>
        </div>
    <?php endif; ?>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" class="empty-data">
                            <?php if ($keyword != '') { ?>
                                Username pembeli tidak ditemukan.
                            <?php } else { ?>
