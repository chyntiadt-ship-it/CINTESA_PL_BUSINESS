...
<div class="admin-container">
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="profile-admin-card" id="profileForm">
        ...
        <div class="profile-form-side">
            ...
            <div class="save-area">
                <button type="submit" name="update" class="save-btn" id="saveBtn">
                    Simpan Perubahan
                </button>
            </div>
...
<script src="../assets/js/profile_admin.js"></script>
